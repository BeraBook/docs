...
export const actions = [
  {
    ...
    text: `Learn about the core concepts of the BeraBook, Segmented Segment Tree, Octopus Heap and more.`,
  },
  {
    title: 'Developers',
    icon: BookOpen,
    to: '/developers/overview',
    text: `Start building with BeraBook, integrate with our SDK, or contribute to our smart contracts.`,
  },
  {
    title: 'Trade Now!',
    icon: ArrowRightCircle,
    to: 'https://berabook.fun',
    text: `A DEX, but like CEX, for Berachain.`,
  },
]
...
export default function Home() {
  return (
    <Layout
      title={`BeraBook Docs`}
      description="Technical Documentation For The BeraBook Protocol"
    >
      <Container>
        <DocsHeader>
          <div
          ...
          >
            <h1 style={{ fontWeight: 600 }}> Welcome to BeraBook Docs</h1>
            {/*<HideMedium>*/}
